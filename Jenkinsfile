pipeline {
  ...
  environment {
    ...
    EXT_USER = 'RPCS3'
    EXT_REPO = 'rpcs3-binaries-linux'
    BUILD_VERSION_ARG = 'RPCS3_VERSION'
    LS_USER = 'linuxserver'
    LS_REPO = 'docker-rpcs3'
    CONTAINER_NAME = 'rpcs3'
    DOCKERHUB_IMAGE = 'linuxserver/rpcs3'
    DEV_DOCKERHUB_IMAGE = 'lsiodev/rpcs3'
    PR_DOCKERHUB_IMAGE = 'lspipepr/rpcs3'
    DIST_IMAGE = 'ubuntu'
    MULTIARCH = 'true'
    CI = 'true'
    CI_WEB = 'true'
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-rpcs3/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-rpcs3\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-rpcs3\" \
          --label \"org.opencontainers.image.version=${EXT_RELEASE_CLEAN}-ls${LS_TAG_NUMBER}\" \
          --label \"org.opencontainers.image.revision=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.vendor=linuxserver.io\" \
          --label \"org.opencontainers.image.licenses=GPL-3.0-only\" \
          --label \"org.opencontainers.image.ref.name=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.title=Rpcs3\" \
          --label \"org.opencontainers.image.description=[RPCS3](https://rpcs3.net/) is a multi-platform open-source Sony PlayStation 3 emulator and debugger written in C++ for Windows, Linux, macOS and FreeBSD.\" \
